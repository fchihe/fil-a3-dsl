...
public interface UiTestPackage extends EPackage
{
   ...
   * @ordered
   */
  int FILL__VALUE = COMMAND_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int SELECT__VALUE = COMMAND_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the reference '{@link org.emn.uiTest.Value#getKeyValue <em>Key Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Key Value</em>'.
   * @see org.emn.uiTest.Value#getKeyValue()
   * @see #getValue()
   * @generated
   */
  EReference getValue_KeyValue();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference VALUE__KEY_VALUE = eINSTANCE.getValue_KeyValue();
