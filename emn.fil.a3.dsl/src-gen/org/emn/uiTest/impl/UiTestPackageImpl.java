...
public class UiTestPackageImpl extends EPackageImpl implements UiTestPackage
{
   ...
   * @generated
   */
  public EAttribute getVerify_Comparison()
  {
   ...
   * @generated
   */
  public EAttribute getSelect_StringValue()
  {
   ...
   * @generated
   */
  public EReference getSelect_KeyValue()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(verifyEClass, VERIFY__COMPARISON);

    selectEClass = createEClass(SELECT);
    createEReference(selectEClass, SELECT__SELECTOR);
    createEAttribute(selectEClass, SELECT__STRING_VALUE);
    createEReference(selectEClass, SELECT__KEY_VALUE);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getVerify_Comparison(), ecorePackage.getEString(), "comparison", null, 0, 1, Verify.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSelect_StringValue(), ecorePackage.getEString(), "stringValue", null, 0, 1, Select.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSelect_KeyValue(), this.getVariableDefinition(), null, "keyValue", null, 0, 1, Select.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
