...
/**
 * This is the item provider adapter for a {@link org.emn.uiTest.Click} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClickItemProvider extends CommandItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Click_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Click_name_feature", "_UI_Click_type"),
				 UiTestPackage.Literals.CLICK__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UiTestPackage.Literals.CLICK__SELECTOR);
		}
	...
	public String getText(Object object) {
		String label = ((Click)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UiTestPackage.Literals.CLICK__SELECTOR,
