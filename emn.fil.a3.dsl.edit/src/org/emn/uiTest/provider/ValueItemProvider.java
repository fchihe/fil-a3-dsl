...
/**
 * This is the item provider adapter for a {@link org.emn.uiTest.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_stringValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_stringValue_feature", "_UI_Value_type"),
				 UiTestPackage.Literals.VALUE__STRING_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addVarNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_varName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_varName_feature", "_UI_Value_type"),
				 UiTestPackage.Literals.VALUE__VAR_NAME,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Value)object).getStringValue();
