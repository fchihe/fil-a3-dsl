...
/**
 * This is the item provider adapter for a {@link org.emn.uiTest.VariableDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableDefinitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableDefinition_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableDefinition_name_feature", "_UI_VariableDefinition_type"),
				 UiTestPackage.Literals.VARIABLE_DEFINITION__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VariableDefinition.class)) {
			case UiTestPackage.VARIABLE_DEFINITION__NAME:
